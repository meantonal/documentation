...
To help understand what this means, let's see how we would represent the notes of a C major scale from C₋₁ to C₀:
...
Meantone constructs a note vector with the following formula:
...
In order to understand intervals and the various operations meantonal can perform, familiarity with [linear algebra](https://en.wikipedia.org/wiki/Linear_algebra) will help greatly. In particular, you will want to be comfortable with:
