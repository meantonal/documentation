...
import ZTonnetz from "../../assets/z-tonnetz.svg";
...
<div class="mt-12">
    ...
    <div class="flex justify-center items-center gap-8">
        <a href="https://cantussy.com">
            <Cantussy class="h-20 w-auto fill-current text-stone-900 dark:text-orange-100" />
        </a>
        <a href="https://ztonnetz.com/">
            <div class="bg-[#1a1a2e] p-1">
                <ZTonnetz class="h-20 w-auto" />
            </div>
        </a>
    </div>
