...
This is potentially useful when calculating the pitch of notes in tuning systems such as quarter comma meantone, where there are an infinite number of distinct notes in the system, since it is **generated** entirely by its fifth and octave (hence the name of this map).
