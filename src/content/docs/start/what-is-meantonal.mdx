...
Currently there is a [JavaScript implementation](/js), a [Python implementation](/python) and a [C implementation](/c) of Meantonal, and they are maintained side by side.
