...
Currently there is only one version of Meantonal, implemented in C. Adding it to your project is as simple as copying the [`meantonal.h`](https://raw.githubusercontent.com/meantonal/meantonal/refs/heads/master/meantonal.h) header file somewhere into your project's directory, or use the following bash script:
