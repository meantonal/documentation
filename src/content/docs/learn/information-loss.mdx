...
1 is therefore the 12-tone pitch class of the note $\sf{C}\sharp$. Since there are an infinite number of integers, but only 12 pitch classes: $\Z\rightarrow\Z_{12}$.
