...
To put things in perspective: $(-125,-50)$ and $(125, 50)$ represent C₋₂₆ and C₂₄ and would be well-represented by the `Note` type even if it were capped at 8-bit integers. That's eome **fifty octaves** of range, or from roughly **240nHz** to **264MHz**.
